...
const roleInfo = [{
  ...
  permissions: ["Full access", "Manage workspace", "Manage projects"]
}, {
  role: "Manager",
  ...
  permissions: ["View projects", "Manage assigned tasks"]
}];
const AdminPage = () => {
  const {
    t
